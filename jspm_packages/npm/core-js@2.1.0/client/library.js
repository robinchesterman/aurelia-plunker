  ...
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      var $export = __webpack_require__(7),
          ...
          ENDS_WITH = 'endsWith',
          $endsWith = ''[ENDS_WITH];
      $export($export.P + $export.F * __webpack_require__(123)(ENDS_WITH), 'String', {endsWith: function endsWith(searchString) {
      ...
      var $export = __webpack_require__(7),
          context = __webpack_require__(121),
          INCLUDES = 'includes';
      $export($export.P + $export.F * __webpack_require__(123)(INCLUDES), 'String', {includes: function includes(searchString) {
      ...
      $export($export.P + $export.F * __webpack_require__(123)(STARTS_WITH), 'String', {startsWith: function startsWith(searchString) {
      ...
      $export($export.S + $export.F * !__webpack_require__(151)(function(iter) {
        Array.from(iter);
      ...
      var $export = __webpack_require__(7),
          toIObject = __webpack_require__(27),
          arrayJoin = [].join;
      $export($export.P + $export.F * (__webpack_require__(28) != Object || !__webpack_require__(154)(arrayJoin)), 'Array', {join: function join(separator) {
      ...
      $export($export.P + $export.F * (fails(function() {
        ...
        test.sort(null);
      }) || !__webpack_require__(154)($sort)), 'Array', {sort: function sort(comparefn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].map, true), 'Array', {map: function map(callbackfn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].filter, true), 'Array', {filter: function filter(callbackfn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].some, true), 'Array', {some: function some(callbackfn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].every, true), 'Array', {every: function every(callbackfn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].reduce, true), 'Array', {reduce: function reduce(callbackfn) {
      ...
      var $export = __webpack_require__(7),
          $reduce = __webpack_require__(165);
      $export($export.P + $export.F * !__webpack_require__(154)([].reduceRight, true), 'Array', {reduceRight: function reduceRight(callbackfn) {
      ...
      $export($export.P + $export.F * !__webpack_require__(154)([].indexOf), 'Array', {indexOf: function indexOf(searchElement) {
      ...
      var $export = __webpack_require__(7),
          ...
          toInteger = __webpack_require__(33),
          toLength = __webpack_require__(32);
      $export($export.P + $export.F * !__webpack_require__(154)([].lastIndexOf), 'Array', {lastIndexOf: function lastIndexOf(searchElement) {
          var O = toIObject(this),
              length = toLength(O.length),
              index = length - 1;
      ...
      var USE_NATIVE = function() {
        ...
        try {
          ...
          SubPromise.prototype = __webpack_require__(41)($Promise.prototype, {constructor: {value: SubPromise}});
          if (!(SubPromise.resolve(5).then(empty) instanceof SubPromise)) {
            works = false;
          }
          if (works && __webpack_require__(5)) {
            var thenableThenGotten = false;
            $Promise.resolve(__webpack_require__(11).f({}, 'then', {get: function() {
      ...
      var $export = __webpack_require__(7);
      $export($export.G + $export.W + $export.F * !__webpack_require__(213).ABV, {DataView: __webpack_require__(214).DataView});
    }, function(module, exports, __webpack_require__) {
      ...
      var $export = __webpack_require__(7),
          $values = __webpack_require__(236)(false);
      ...
      var $export = __webpack_require__(7),
          $entries = __webpack_require__(236)(true);
